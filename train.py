...
parser.add_argument("hdf5_dir", metavar="HDF5_DIR", type=str, help="Path to the hdf5 file")
...
def train(in_dir, hdf5_dir, hdf5_name, dim_patch=224, pre_trained='', rs_rate=4, balancing=False):
    """
    Training pipeline
...
def main():
    ...
    train(args.in_dir, args.hdf5_dir, args.hdf5_file, dim_patch=args.dim_patch,
